...
namespace FuYang.Infrastructure.Migrations
{
    ...
    [Migration("20210604055343_addDataIdToInspectionReportAppearanceEntityAndReportInfoToDataEntity")]
    partial class addDataIdToInspectionReportAppearanceEntityAndReportInfoToDataEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.DataDeliver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.ToTable("t_data_deliver");
                });

            modelBuilder.Entity("Core.Entities.DataInspection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.ToTable("t_data_inspection");
                });

            modelBuilder.Entity("Core.Entities.DataStorage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Core.Entities.GroupDeliver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.ToTable("t_group_deliver");
                });

            modelBuilder.Entity("Core.Entities.GroupInspection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.ToTable("t_group_inspection");
                });

            modelBuilder.Entity("Core.Entities.GroupStorage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Core.Entities.DataDeliver", b =>
                {
                    b.HasOne("Core.Entities.GroupStorage", "GroupStorage")
                        .WithMany()
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entities.DataInspection", b =>
                {
                    b.HasOne("Core.Entities.GroupInspection", "GroupInspection")
                        .WithMany()
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
